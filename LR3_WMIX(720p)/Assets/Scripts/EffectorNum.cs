...
public class EffectorNum : MonoBehaviour {
    ...
    [HideInInspector] public enum FXname : byte{
        MasterVolume = 1, KeyVolume = 2, BGMVolume = 3,
        EQ62 = 4, EQ160 = 5, EQ400 = 6, EQ1000 = 7,
        EQ2500 = 8, EQ6300 = 9, EQ16000 = 10,
        Frequency = 11, Pitch = 12, Distortion = 19,
        ChorusDelay = 20, ChorusRate = 21,
        ChorusDepth = 22, // Flanger = 25,
        EchoDelay = 13, EchoDecayRatio = 14,
        LowPassCutoff = 15, LowPassRQ = 16,
        HighPassCutoff = 17, HighPassRQ = 18,
