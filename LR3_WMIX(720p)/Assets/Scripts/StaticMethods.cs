...
public static class StaticMethods{
    ...
    /// <summary>
    /// returns 0 if the string is null or the length isn't 2
    /// </summary>
    /// <param name="s"></param>
    ...
    /// <param name="ffmpegEngine"></param>
    public static async Task ConvertVideoByFilePath(string input, string output, FFmpegEngine ffmpegEngine){
        if (ffmpegEngine == null) { return; }
        ...
        await ffmpegEngine.ConvertAsync(inputFile, outputFile);
        return;
    }
}
